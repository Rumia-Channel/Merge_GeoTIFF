...
class main(Form):
    ...
    def execution(self):
        ...
        #実行
        command = f'start Merge_GeoTIFF.exe --input-dir "{input_dir}" --output-dir "{output_dir}" --sigma {sigma} {output_graphs} --data-excluded {data_excluded} --data-excluded_u {data_excluded_u} --data-excluded_l {data_excluded_l} {not_flat_earth} {ue_landscape} {small_units}'
